...
public class SlotItemLayout extends LinearLayout implements WearableListView.OnCenterProximityListener {
    ...
    public SlotItemLayout(Context context) {
        this(context, null);
    }

    public SlotItemLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlotItemLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        // (see next section)
        mCircle = (ImageView) findViewById(R.id.slotImage);
        mName = (TextView) findViewById(R.id.slotName);
    }
